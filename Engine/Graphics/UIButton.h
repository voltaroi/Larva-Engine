...
public:
    ...
    void init(float x, float y, AnchorH anchorH = AnchorH::Left, AnchorV anchorV = AnchorV::Top,
              float width = 0.0f, float height = 0.0f, const std::string& label = "", float r = 1.0f, float g = 1.0f, float b = 1.0f, 
              bool border = false, float radius = 0.0f ,std::function<void()> onClick = nullptr);
    ...
    void setPosition(float x, float y, float width = 0.0f, float height = 0.0f);
private:
