// Wrapper pour mapper les appels stbi_* vers assimp_stbi_*
// car Assimp préfixe ses symboles stb_image

extern "C" {
    // Déclarations des fonctions assimp_stbi
    ...
    // Wrappers qui redirigent vers assimp_stbi
